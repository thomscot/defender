...
var bootstrap = require('express-bootstrap-service')
 ...
 , monk = require('monk')
 , db = monk(process.env.MONGODB_URI || 'localhost:27017/defender', { bufferMaxEntries: 0 }) // as attempt to issue a command to db immediately the failure is returned if there's no connection
