...
var bootstrap = require('express-bootstrap-service')
 ...
 , monk = require('monk')
 , db = monk(process.env.MONGODB_URI || 'localhost:27017/defender', { bufferMaxEntries: 0 }) // as one attempts to issue a command to db, the failure is returned immediately if there's no connection
